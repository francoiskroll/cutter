...
#' allelesToMutations
#'
#' @param alpath path to one Alleles_frequency_table, created by CRISPResso2
#'
#' @returns
#' @export
#'
...
#' alleleToMutation
#'
#' @param ref one aligned reference, split
#' @param ali one aligned sequence, split
#' @param nreads
#' @param rowi
#'
#' @returns
...
#' recordRef
#'
#' @param ref reference sequence (aligned), split
#' @param ali aligned sequence, split
#'
#' @returns
#' @export
#'
...
#' recordSub
#'
#' @param ref aligned reference, split
#' @param ali aligned sequence, split
#'
#' @returns
#' @export
